...
const Page = () => {
  ...
  return (
    <div
      className={`w-full bg-slate-50 flex flex-col items-center py-8 font-sans text-slate-800 ${form ? "overflow-hidden h-screen" : "min-h-screen"}`}
    >
      <div className="w-full flex flex-col items-center gap-12 px-4 sm:px-6 md:px-8 max-w-7xl">
        <div className="flex flex-col bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-200 p-6 md:p-10 w-full max-w-5xl relative gap-8">
          <div className="flex flex-col w-full relative">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between p-4 md:p-6 bg-slate-50 rounded-2xl border border-slate-200 w-full shadow-inner gap-4">
              <div className="w-full text-center sm:text-left text-3xl md:text-4xl font-semibold text-slate-800 bg-transparent outline-none border-none min-w-0 font-mono tracking-tight">
                {generatepassword}
              </div>
              ...
              <div className="flex flex-row items-center gap-4 shrink-0">
                {/* Retry Button */}
                <button
                  className="p-3 text-slate-400  hover:bg-white rounded-full transition-all duration-200 cursor-pointer flex items-center justify-center shadow-sm border border-transparent hover:border-slate-200 active:scale-95"
                ...
                {/* Copy Button */}
                <button className="bg-blue-600 hover:bg-blue-700 cursor-pointer text-white font-bold p-3  rounded-xl whitespace-nowrap transition-all shadow-lg shadow-blue-600/30 active:scale-95">
                  <img src="/copy.svg" alt="copy" className="w-6 h-6" />
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-8 bg-slate-50/80 border border-slate-100 p-4  w-full rounded-2xl">
              ...
              <div className="flex flex-col md:flex-row justify-between md:items-center gap-6">
                ...
                <input
                  ...
                  className="w-full h-2.5 font-light bg-slate-200 rounded-full cursor-pointer  accent-blue-600 flex-1 "
                />
              </div>
        ...
        <div className="flex flex-col w-full max-w-5xl items-center bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-200 p-6 md:p-10 gap-8 relative">
          <div className="w-full text-center pb-2">
            <h1 className="font-extrabold text-3xl md:text-4xl text-slate-800 tracking-tight">
              Vault Records
            </h1>
          </div>
                ...
                {val.map((row, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-slate-600 font-mono tracking-tight">
                      <span className="bg-slate-100 px-3 py-1.5 rounded-lg border border-slate-200 group-hover:bg-white transition-colors">
                        {row.Password}
                      </span>
                    </td>
      ...
      {form && (
        <div className="flex flex-col justify-center items-center w-screen h-screen absolute z-[10]">
